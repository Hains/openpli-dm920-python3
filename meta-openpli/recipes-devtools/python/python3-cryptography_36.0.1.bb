...
inherit cargo pypi python3-dir setuptools3 siteinfo
...
export PYO3_CONFIG_FILE="${WORKDIR}/python3-cryptography.pyo3-config"
...
# bitbake vendoring does not work with setuptools-rust, yet
...
do_configure:prepend () {
    cat > ${WORKDIR}/python3-cryptography.pyo3-config << EOF
